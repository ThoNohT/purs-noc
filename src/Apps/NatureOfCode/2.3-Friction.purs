-- | Implements mover that has friction added to the forces being applied to it as shown in https://www.youtube.com/watch?v=WBdhAuWS6X8.
module Apps.NatureOfCode.Friction (app) where
...
import Model.Vector (Vector2, getX, getY, normalize, scale, setMagnitude, setX, setY, (<=>), (|*|), (|/|))
...
initialize state =
  let
    mover pos mass = { pos: pos <=> 200.0, vel: zero, mass: mass, radius: 10.0 * Math.sqrt mass }
